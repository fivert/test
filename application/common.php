...
function WSTRSA($hex_encrypt_data){
	...
	$isCrypt = 1;//WSTConf('CONF.isCryptPwd');
	if($isCrypt==0) return WSTReturn('success1',1,$hex_encrypt_data);
	
	// $private_key = WSTConf('CONF.pwdPrivateKey');
	$private_key = "-----BEGIN RSA PRIVATE KEY-----

-----END RSA PRIVATE KEY-----";
	if($private_key=='') return WSTReturn('fail1');
	try{
		$encrypt_data = pack("H*", $hex_encrypt_data); //对十六进制数据进行转换
		openssl_private_decrypt($encrypt_data, $decrypt_data, $private_key); //解密数据
		// halt(WSTReturn('success2',1,$decrypt_data));
		return WSTReturn('success2',1,$decrypt_data);
	}catch(\Exception $e){
        return WSTReturn($e);
	}
}
